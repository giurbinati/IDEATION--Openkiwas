...
class Autosubmit extends ExposedFormPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['timeout'] = [
      ...
      '#min' => 0,
      '#max' => '10000',
      '#title' => $this->t('Timeout for text input'),
      '#description' => $this->t('Timeout in milliseconds for form submission after the user stops typing.'),
  ...
  public function exposedFormAlter(&$form, FormStateInterface $form_state) {
    ...
    $form['#attached']['drupalSettings']['views_autosubmit'] = [
